...
<body>
	...
	<div class="intro intro-carousel">
		...
		<div id="carousel" class="owl-carousel owl-theme">
			<div class="carousel-item-a intro-item bg-image"
				style="background-image: url(${pageContext.request.contextPath}/assets/img/main1.jpg)">
			...
			<div class="carousel-item-a intro-item bg-image"
				style="background-image: url(${pageContext.request.contextPath}/assets/img/main2.jpg)">
				<div class="overlay overlay-a"></div>
				<div class="intro-content display-table">
					<div class="table-cell">
						<div class="container">
			...
			<div class="carousel-item-a intro-item bg-image"
				style="background-image: url(${pageContext.request.contextPath}/assets/img/main3.jpg)">
				<div class="overlay overlay-a"></div>
				<div class="intro-content display-table">
					<div class="table-cell">
						<div class="container">
	...
	<section class="section-property section-t8">
		<div class="container">
			...
			<div id="property-carousel"
				class="owl-carousel owl-theme main-product-image">
				...
				<c:forEach items="${productList}" var="product">
						...
						<div class="carousel-item-b ">
							...
							<div class="card-box-a card-shadow">
								...
								<div class="img-box-a">
									<img src="${cdnUrl}/${product.mainImage}"
										class="img-a img-fluid">
								</div>
			<a href="${cdnUrl}/product/detail?no=${product.no}" class="link-a">
			</a>
								<div class="card-overlay">
									<div class="card-overlay-a-content">
										...
										<div class="card-body-a">
											...
											<span class="ion-ios-arrow-forward">${product.description}</span>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="title-wrap d-flex justify-content-between">
						...
						<div class="title-link">
							<a href="agents-grid.html">All Agents <span
								class="ion-ios-arrow-forward"></span>
							</a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card-box-d">
						<div class="card-img-d">
							<img
								src="${pageContext.request.contextPath}/assets/img/agent-4.jpg"
				...
				<div class="col-md-4">
					<div class="card-box-d">
						<div class="card-img-d">
							<img
								src="${pageContext.request.contextPath}/assets/img/agent-1.jpg"
								alt="" class="img-d img-fluid">
						</div>
						<div class="card-overlay card-overlay-hover">
							<div class="card-header-d">
				...
				<div class="col-md-4">
					<div class="card-box-d">
						<div class="card-img-d">
							<img
								src="${pageContext.request.contextPath}/assets/img/agent-5.jpg"
								alt="" class="img-d img-fluid">
						</div>
						<div class="card-overlay card-overlay-hover">
							<div class="card-header-d">
			...
			<div id="new-carousel" class="owl-carousel owl-theme">
				<div class="carousel-item-c">
					<div class="card-box-b card-shadow news-box">
						<div class="img-box-b">
							<img
								src="${pageContext.request.contextPath}/assets/img/post-2.jpg"
				...
				<div class="carousel-item-c">
					<div class="card-box-b card-shadow news-box">
						<div class="img-box-b">
							<img
								src="${pageContext.request.contextPath}/assets/img/post-5.jpg"
								alt="" class="img-b img-fluid">
						</div>
						<div class="card-overlay">
							<div class="card-header-b">
				...
				<div class="carousel-item-c">
					<div class="card-box-b card-shadow news-box">
						<div class="img-box-b">
							<img
								src="${pageContext.request.contextPath}/assets/img/post-7.jpg"
								alt="" class="img-b img-fluid">
						</div>
						<div class="card-overlay">
							<div class="card-header-b">
				...
				<div class="carousel-item-c">
					<div class="card-box-b card-shadow news-box">
						<div class="img-box-b">
							<img
								src="${pageContext.request.contextPath}/assets/img/post-3.jpg"
								alt="" class="img-b img-fluid">
						</div>
						<div class="card-overlay">
							<div class="card-header-b">
						...
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="testimonial-img">
									<img
										src="${pageContext.request.contextPath}/assets/img/testimonial-1.jpg"
										alt="" class="img-fluid">
								</div>
							</div>
							<div class="col-sm-12 col-md-6">
								...
								<div class="testimonial-author-box">
									<img
										src="${pageContext.request.contextPath}/assets/img/mini-testimonial-1.jpg"
					...
					<div class="testimonials-box">
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="testimonial-img">
									<img
										src="${pageContext.request.contextPath}/assets/img/testimonial-2.jpg"
										alt="" class="img-fluid">
								</div>
							</div>
							<div class="col-sm-12 col-md-6">
								...
								<div class="testimonial-author-box">
									<img
										src="${pageContext.request.contextPath}/assets/img/mini-testimonial-2.jpg"
										alt="" class="testimonial-avatar">
	...
	<script
		src="${pageContext.request.contextPath}/assets/lib/jquery/jquery.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/lib/jquery/jquery-migrate.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/lib/popper/popper.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/lib/bootstrap/js/bootstrap.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/assets/lib/scrollreveal/scrollreveal.min.js"></script>

	<!-- Contact Form JavaScript File -->
	<script
		src="${pageContext.request.contextPath}/assets/js/contactform.js"></script>
